#ifndef funtxt_data_nodeFlexLexer_HPP_INCLUDED
#define funtxt_data_nodeFlexLexer_HPP_INCLUDED 1


/**
   funtxt_data_nodeFlexLexer is an auto-generated class and is NOT part of the
...
*/
class funtxt_data_nodeFlexLexer : public FlexLexer {
public:
        // arg_yyin and arg_yyout default to the cin and cout, but we
        // only make that assignment when initializing in yylex().
        funtxt_data_nodeFlexLexer( istream* arg_yyin = 0, ostream* arg_yyout = 0 );

        virtual ~funtxt_data_nodeFlexLexer();
...
#endif // funtxt_data_nodeFlexLexer_HPP_INCLUDED
