...
#ifndef _HOOK_LINK_LIB_H_
#define _HOOK_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libhook


#if defined(USING_LOCAL_DLL) || defined(USING_ALL_DLL) || defined(USING_hook_DLL)
