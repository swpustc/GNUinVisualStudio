...
#ifndef _XMLRPC_ABYSS_LINK_LIB_H_
#define _XMLRPC_ABYSS_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libxmlrpc_abyss


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_xmlrpc_abyss_DLL)
...
#endif /* _XMLRPC_ABYSS_LINK_LIB_H_ */
