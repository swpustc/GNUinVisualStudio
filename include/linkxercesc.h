...
#ifndef _XERCES-C_LINK_LIB_H_
#define _XERCES-C_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        xerces-c


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_xercesc_DLL)
