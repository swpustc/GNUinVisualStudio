...
#ifndef _XMLRPC_CLIENT_LINK_LIB_H_
#define _XMLRPC_CLIENT_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libxmlrpc_client


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_xmlrpc_client_DLL)
...
#endif /* _XMLRPC_CLIENT_LINK_LIB_H_ */
