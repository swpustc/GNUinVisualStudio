...
#ifndef _XML2_LINK_LIB_H_
#define _XML2_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libxml2


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_xml2_DLL)
