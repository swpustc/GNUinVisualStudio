...
#ifndef _S11N_LINK_LIB_H_
#define _S11N_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libs11n


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_s11n_DLL)
