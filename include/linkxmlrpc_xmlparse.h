...
#ifndef _XMLRPC_XMLPARSE_LINK_LIB_H_
#define _XMLRPC_XMLPARSE_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libxmlrpc_xmlparse


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_xmlrpc_xmlparse_DLL)
#  include "_linkdynamic"
#else
#  include "_linkstatic"
#  include "linkxmlrpc_util.h"
#  include "linkxmlrpc_xmltok.h"
#endif


#undef __GNU_PROJECT_NAME__

#endif /* _XMLRPC_XMLPARSE_LINK_LIB_H_ */
