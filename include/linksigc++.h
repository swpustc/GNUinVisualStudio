...
#ifndef _SIGC_PLUSPLUS_LINK_LIB_H_
#define _SIGC_PLUSPLUS_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libsigc++


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_sigcpp_DLL)
...
#endif /* _SIGC_PLUSPLUS_LINK_LIB_H_ */
