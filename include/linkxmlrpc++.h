...
#ifndef _XMLRPC_PLUSPLUS_LINK_LIB_H_
#define _XMLRPC_PLUSPLUS_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libxmlrpc++


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_xmlrpcpp_DLL)
...
#  include "linkxmlrpc_client.h"
#  include "linkxmlrpc_server.h"
#  include "linkxmlrpc_server_abyss.h"
...
#endif /* _XMLRPC_PLUSPLUS_LINK_LIB_H_ */
