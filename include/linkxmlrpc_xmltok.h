...
#ifndef _XMLRPC_XMLTOK_LINK_LIB_H_
#define _XMLRPC_XMLTOK_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libxmlrpc_xmltok


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_xmlrpc_xmltok_DLL)
...
#endif /* _XMLRPC_XMLTOK_LINK_LIB_H_ */
