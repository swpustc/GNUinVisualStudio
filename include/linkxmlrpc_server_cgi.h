...
#ifndef _XMLRPC_SERVER_CGI_LINK_LIB_H_
#define _XMLRPC_SERVER_CGI_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libxmlrpc_server_cgi


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_xmlrpc_server_cgi_DLL)
...
#endif /* _XMLRPC_SERVER_CGI_LINK_LIB_H_ */
