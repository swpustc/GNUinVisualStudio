...
#ifndef _XMLRPC_LINK_LIB_H_
#define _XMLRPC_LINK_LIB_H_
...
#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_xmlrpc_DLL)
#  include "_linkdynamic"
#else
#  include "_linkstatic"
#  include "linkxmlrpc_util.h"
#  include "linkxmlrpc_xmlparse.h"
#endif


#undef __GNU_PROJECT_NAME__

#endif /* _XMLRPC_LINK_LIB_H_ */
