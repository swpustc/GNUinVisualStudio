...
#ifndef _GMP_LINK_LIB_H_
#define _GMP_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libgmp


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_gmp_DLL)
