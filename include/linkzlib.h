...
#ifndef _ZLIB_LINK_LIB_H_
#define _ZLIB_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        zlib


#if defined ZLIB_WINAPI && !defined _M_X64
/*  This zlib library donot use WINAPI/WINAPIV calling convention, if you
  define ZLIB_WINAPI, undefine it. */
/*  In AMD64, there is only one calling convention is __cdecl. */
#  error zlib library do not use WINAPI/WINAPIV calling convention.
#endif


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_zlib_DLL)
