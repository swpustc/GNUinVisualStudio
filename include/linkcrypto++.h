...
#ifndef _CRYPTO_PLUSPLUS_LINK_LIB_H_
#define _CRYPTO_PLUSPLUS_LINK_LIB_H_

#ifdef __GNU_PROJECT_NAME__
#  undef __GNU_PROJECT_NAME__
#endif
#define __GNU_PROJECT_NAME__        libcrypto++


#if defined(USING_GNU_DLL) || defined(USING_ALL_DLL) || defined(USING_cryptopp_DLL)
...
#endif /* _CRYPTO_PLUSPLUS_LINK_LIB_H_ */
